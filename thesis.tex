...
\usepackage{hyperref}  % for workin links and bookmarks (alexsalo), and can help make references to other chapters and sections.
\usepackage[capitalise]{cleveref}  % used to format references to ranges of references.
\usepackage{bookmark}  % faster bookmarks management (alexsalo)
\usepackage{ifthen}
